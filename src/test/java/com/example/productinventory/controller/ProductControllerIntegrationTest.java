...
//     // This can be done by using a DELETE request or by ensuring the database is reset before
// each
//     // test
//   }
...
//   //             .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Product with ID
// 999
//   // not found"));
//   // }
